...
export function LogoIcon({ className = '', size = 32 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <rect width="32" height="32" rx="8" fill="#10b981" fillOpacity="0.15" />
      <rect x="5" y="18" width="4" height="9" rx="1" fill="#10b981" />
      <rect x="11" y="13" width="4" height="14" rx="1" fill="#34d399" />
      <rect x="17" y="8" width="4" height="19" rx="1" fill="#10b981" />
      <rect x="23" y="4" width="4" height="23" rx="1" fill="#6ee7b7" />
      <path
        d="M5 14 L9 10 L15 13 L21 6 L27 3"
        stroke="#10b981"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
